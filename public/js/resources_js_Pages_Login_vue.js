...
var _hoisted_1 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createStaticVNode)("<div id=\"login-modal\"><div class=\"modal\" data-bs-backdrop=\"static\" data-bs-keyboard=\"false\" tabindex=\"-1\" aria-labelledby=\"login-modal-label\" aria-hidden=\"true\"><div class=\"modal-dialog\"><div class=\"modal-content\"><div class=\"modal-header\"><h5 class=\"modal-title\" id=\"login-modal-label\">Login</h5><button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"modal\" aria-label=\"Close\"></button></div><div class=\"modal-body\"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore, officia excepturi dolorem repellendus optio dolores quidem dicta quia pariatur odio aut obcaecati eligendi eos reiciendis, velit commodi non esse consequatur. </div><div class=\"modal-footer\"><button type=\"button\" class=\"btn btn-secondary\" data-bs-dismiss=\"modal\"> Close </button><button type=\"button\" class=\"btn btn-primary\">Understood</button></div></div></div></div></div>", 1);

function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [_hoisted_1, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <div id=\"login-modal\">\n    <div class=\"modal-dialog modal-fullscreen\">\n      <h3>Login</h3>\n      <p v-if=\"loading\">Loading...</p>\n      <p v-if=\"error\" style=\"color: red\">{{ error }}</p>\n      <input type=\"text\" placeholder=\"Username\" v-model=\"user.username\" /><br />\n      <input type=\"text\" placeholder=\"Password\" v-model=\"user.password\" /><br />\n      <button @click=\"login\">Login</button>\n    </div>\n  </div> ")], 2112
